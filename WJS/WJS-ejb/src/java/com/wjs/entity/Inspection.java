...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Inspection.findAll", query = "SELECT i FROM Inspection i ORDER BY i.status ASC, i.credate DESC,i.id DESC"),
    ...
    @NamedQuery(name = "Inspection.findRowCount", query = "SELECT count(i) FROM Inspection i  "),  
    ...
    @NamedQuery(name = "Inspection.findVerifiedRowCount", query = "SELECT count(i) FROM Inspection i WHERE i.status='V' ")})
